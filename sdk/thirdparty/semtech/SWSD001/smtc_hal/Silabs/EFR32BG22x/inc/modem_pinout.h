/*****************************************************************************
  ...
  Copyright 2023 Laird Connectivity. All rights reserved.

  The information contained herein is property of Laird Connectivity.
  Terms and conditions of usage are described in detail in LAIRD
  CONNECTIVITY STANDARD SOFTWARE LICENSE AGREEMENT.

  YOU FURTHER ACKNOWLEDGE AND AGREE THAT THE SOFTWARE AND DOCUMENTATION ARE
  PROVIDED AS IS WITHOUT WARRANTY OF ANY KIND, EITHER EXPRESS OR IMPLIED,
  INCLUDING WITHOUT LIMITATION, ANY WARRANTY OF MERCHANTABILITY, TITLE,
  NON-INFRINGEMENT AND FITNESS FOR A PARTICULAR PURPOSE. IN NO EVENT SHALL
  LAIRD CONNECTIVITY OR ITS LICENSORS BE LIABLE OR OBLIGATED UNDER CONTRACT,
  ...
  contact Laird Connectivity at www.lairdconnect.com.
*******************************************************************************/
