...
# RM126x Template Applications - RM126x Class A Environmental data
...
This template application demonstrates LoRaWAN Class A functionality for the [RM1261][RM126x module datasheet] and [RM1262][RM126x module datasheet]. Temperature, humidity and air quality data, read from a [MikroE Environment 2 Click board][MikroE Environment 2 Click board product page], is included in each uplink.
...
The Environment 2 Click board is shown below.

![MikroE Environment 2 Click](images/mikroe_4558_profile.jpg)
...
![RM126x DVK with MikroE Environment 2 Click](images/rm126x_mikroe_4558_profile.jpg)
...
During start-up, the Environment 2 board is initialised then peripherals associated with the Semtech radio started and the LoRaWAN stack initialised.
...
Upon successful connection, the application will send periodic uplinks containing a 2-byte uplink count and the latest temperature, humidity and air quality readings from the Environment 2 board.

The uplink data is formatted as shown below.

![Uplink count and Environment 2 payload](images/rm126x_uplink_4558.jpg)

Temperature and humidity data is encoded into 8-bit integer and fractional parts.
