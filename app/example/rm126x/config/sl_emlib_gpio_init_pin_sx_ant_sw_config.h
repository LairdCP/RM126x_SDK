#ifndef SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW]
#define SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_PORT    gpioPortB
#define SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_PIN     1
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_SX_ANT_SW_CONFIG_H
