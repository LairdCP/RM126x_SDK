#ifndef SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_SX_NRESET
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_NRESET]
#define SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_PORT    gpioPortA
#define SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_PIN     6
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_NRESET]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_SX_NRESET_CONFIG_H
