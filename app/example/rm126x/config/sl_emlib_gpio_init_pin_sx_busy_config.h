#ifndef SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_SX_BUSY
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_BUSY]
#define SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_PORT      gpioPortA
#define SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_PIN       7
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_BUSY]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_SX_BUSY_CONFIG_H
