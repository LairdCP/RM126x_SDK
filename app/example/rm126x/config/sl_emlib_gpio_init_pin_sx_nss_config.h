#ifndef SL_EMLIB_GPIO_INIT_PIN_SX_NSS_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_SX_NSS_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_SX_NSS_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_SX_NSS_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_PIN_SX_NSS_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_SX_NSS_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_SX_NSS
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_NSS]
#define SL_EMLIB_GPIO_INIT_PIN_SX_NSS_PORT       gpioPortB
#define SL_EMLIB_GPIO_INIT_PIN_SX_NSS_PIN        0
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_SX_NSS]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_SX_NSS_CONFIG_H
