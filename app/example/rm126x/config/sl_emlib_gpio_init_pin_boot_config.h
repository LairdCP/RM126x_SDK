#ifndef SL_EMLIB_GPIO_INIT_PIN_BOOT_CONFIG_H
#define SL_EMLIB_GPIO_INIT_PIN_BOOT_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_PIN_BOOT_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_PIN_BOOT_MODE        gpioModeInputPull

// <o SL_EMLIB_GPIO_INIT_PIN_BOOT_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_PIN_BOOT_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_PIN_BOOT
// $[GPIO_SL_EMLIB_GPIO_INIT_PIN_BOOT]
#define SL_EMLIB_GPIO_INIT_PIN_BOOT_PORT         gpioPortC
#define SL_EMLIB_GPIO_INIT_PIN_BOOT_PIN          6
// [GPIO_SL_EMLIB_GPIO_INIT_PIN_BOOT]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_PIN_BOOT_CONFIG_H
